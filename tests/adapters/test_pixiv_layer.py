...
from copixiv.pixiv.account import (
...
from copixiv.pixiv.errors import PixivApiError, PixivHttpError
from copixiv.pixiv import patch as pixiv_patch
...
class TestPixivPatches:
    ...
    def test_permissive_model_construct_fallback_chain(self):
        from copixiv.pixiv.patch import _permissive_model_construct

"""Novel WRITE repository — upserts, deletes, tag/favourite mutations.

Split out of the monolithic ``novel.py`` (docs/MODULARITY.md §M4).
Read queries live in ``novel_read.py``; the facade class
...
from sqlalchemy import (
    select, func, case, update, delete as _delete, text,
